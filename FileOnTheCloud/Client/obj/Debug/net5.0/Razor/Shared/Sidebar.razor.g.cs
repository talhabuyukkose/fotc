#pragma checksum "C:\Users\talha\source\repos\fileonthecloud\FileOnTheCloud\FileOnTheCloud\Client\Shared\Sidebar.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b2f1b5ba6f4b4f63facc55e2b171154c92bbe587"
// <auto-generated/>
...
#nullable disable
    public partial class Sidebar : Microsoft.AspNetCore.Components.ComponentBase
    {
        ...
        {
            __builder.AddMarkupContent(0, @"<section id=""adminPanel""><div class=""adminTitle"">
            KONTROL PANELİ
        </div>
        <div class=""adminName"">
            Sn. Doç Dr. Tacim Hoylu
        </div>
        <div class=""adminButtons""><a href class=""button"">Not Ekle</a>
            <button id=""messageSend"" class=""button"">Yönetici ile İletişime Geç</button></div></section>");
        }
